            ...
            <form action="{{ route('schedule') }}" method="post">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="mb-4">
                            <label style="color: rgb(252, 254, 254)" id="plane1">Departure time </label>
                            <input type="time" name="time" id="plane1"
                        ...
                        <div class="mb-4">
                            ...
                            <select id="town" name="depart"
                                class="form-select @error('depart') is-invalid @enderror">
