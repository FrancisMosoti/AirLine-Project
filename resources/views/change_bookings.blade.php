                        ...
                        <div class="div_deg">
                            ...
                            <div class="content">
                                <center>
                                    ...
                                    <div class="container text-center">
                                        <div class="row align-items-start">
                                            <div class="col">
                                                <form action="">
                                                    <div>
                                                        <input type=" submit " class="btn btn-primary" name="Round trip"
                                                            value="Round trip" />
                                                    </div>
                                                    <br />
                                                    <div>
                                                    ...
                                                    <br />
                                                    <div>
                                                        <label style="color: rgb(252, 254, 254)">Departure date:</label>
                                                        <br />
                                            ...
                                            <div class="col">
                                                <form action="">
                                                    <div>
                                                        <input type=" submit " class="btn btn-primary" name="One-way"
                                                            value="One-way" />
                                                    </div>
                                                    <br />
                                                    <div>
                                    ...
                                    <br />
                                    <div>
                                        <input type=" submit " class="btn btn-primary" name="Update ticket"
                                            value="Update ticket" />
                                    </div>
                                </center>
                            </div>
